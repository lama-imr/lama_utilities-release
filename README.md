## lama_utilities (indigo) - 0.1.8-0

The packages in the `lama_utilities` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo lama_utilities` on `Wed, 21 Jan 2015 06:38:24 -0000`
